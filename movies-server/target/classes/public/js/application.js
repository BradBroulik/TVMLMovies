//# sourceURL=server-application.js
...
App.onLaunch = function(options) {
    ...
    /**
     * evaluateScripts is responsible for loading the JavaScript files necessary
    ...
    evaluateScripts(javascriptFiles, function(success) {
        if (success) {
            ...
            /* Example to load a TMVL document via server-side template */
          // resourceLoader.loadDocument(`${options.BASEURL}/movies.tvml`,
          //     function(doc) {
          ...
          // );
            ...
            /* Example to load a TMVL document via client-side template */
           resourceLoader.loadResource(`${options.BASEURL}js/templates/Movies.tvml.js`, 
                   function(resource) {
...
/**
 * This convenience function returns an alert template, which can be user to present errors to the user.
 */
