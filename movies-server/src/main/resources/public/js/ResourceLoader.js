...
function or the XMLHttpRequest object.
*/
/**
...
/**
 * @description This function loads a document then invokes the callback
 * @param {String} url - The URL to a TVML file
 * @param {Function} callback - The callback to invoke after successfully loading the document
 */
ResourceLoader.prototype.loadDocument = function(url, callback) {
    var self = this;
